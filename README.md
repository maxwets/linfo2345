...
The MD5 function is susceptible to [collision attacks](https://en.wikipedia.org/wiki/MD5#Collision_vulnerabilities), so an attacker could try to forge collisions on purpose in order to push invalid blocks.
